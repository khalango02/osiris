    ...
    <main className="fixed inset-0 w-full h-full bg-[var(--bg-void)] overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 2.5 }} className={`absolute top-4 left-6 md:left-[120px] z-[200] pointer-events-none flex flex-col`}>
        <div className="flex items-center gap-4">
          <svg viewBox="0 0 650 500" className="w-10 h-10 md:w-12 md:h-12 shrink-0 transition-colors duration-500 text-[#D4AF37] drop-shadow-[0_0_8px_rgba(255,215,0,0.5)]" fill="currentColor">
          ...
          <div className="flex flex-col items-start gap-0.5">
            <h1 className="text-xl md:text-2xl font-bold tracking-[0.4em] text-[#D4AF37] font-mono">OSIRIS</h1>
            <span className="text-[9px] md:text-[11px] font-mono tracking-[0.2em] opacity-80 uppercase text-[#D4AF37]">GLOBAL INTELLIGENCE COMMAND</span>
          </div>
        </div>
        <div className="flex items-center gap-4 mt-2 pl-[60px]">
          <span className="text-[6px] md:text-[8px] text-[var(--text-muted)] font-mono tracking-[0.3em] uppercase opacity-40">
